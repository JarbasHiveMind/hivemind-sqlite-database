...
- test: drop removed crypto\_key field from client round-trip tests [\#69](https://github.com/JarbasHiveMind/hivemind-sqlite-database/pull/69) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: give each thread its own SQLite connection [\#54](https://github.com/JarbasHiveMind/hivemind-sqlite-database/pull/54) ([JarbasAl](https://github.com/JarbasAl))
...
- docs: rewrite README in Simplified Technical English [\#50](https://github.com/JarbasHiveMind/hivemind-sqlite-database/pull/50) ([JarbasAl](https://github.com/JarbasAl))
